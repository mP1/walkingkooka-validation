 ...
 */
final class ValidationExpressionFunctionRequiredFormFields<R extends ValidationReference, S, C extends ValidatorExpressionEvaluationContext<R, S>> extends ValidationExpressionFunction<R, C, ValidationErrorList<R>> {

    static <R extends ValidationReference, S, C extends ValidatorExpressionEvaluationContext<R, S>> ValidationExpressionFunctionRequiredFormFields<R, S, C> with(final Set<R> fields) {
        Objects.requireNonNull(fields, "fields");

        return new ValidationExpressionFunctionRequiredFormFields<>(
            Sets.immutable(fields)
        );
    }

    private ValidationExpressionFunctionRequiredFormFields(final Set<R> fields) {
