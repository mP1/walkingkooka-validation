...
abstract class ValidationExpressionFunction<R extends ValidationReference, C extends ExpressionEvaluationContext, T> implements ExpressionFunction<T, C> {
    ...
    /**
     * A parameter to fetch form fields.
     */
